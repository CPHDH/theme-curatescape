...
<article class="page show">
	...
	<p id="thanks">Thank you for sharing your garden story. You will receive an email confirmation within 24 hours. We will review your submission and you will receive a second email confirmation when your story appears on the Community of Gardens website. Meanwhile, feel free to <?php echo contribution_link_to_contribute('make another contribution'); ?> or <a href="<?php echo url('items/browse'); ?>">browse the archive</a>.</p>
...
<?php echo mh_share_this('Site','var addthis_share ={"url":"http://www.communityofgardens.org"}');?>
</div>
</div>
