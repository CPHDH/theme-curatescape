...
<article class="story item show" role="main" id="content">
	<header id="story-header">
		<?php
			...
			echo '<div class="item-hero-text">';
				...
				if(plugin_is_active('Curatescape') && get_option('curatescape_template')){
	...
	<section class="text <?php if (get_option('curatescape_template')) echo 'use-curatescape-template';?>">
