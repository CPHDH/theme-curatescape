        ...
        function checkWidth() {
	        ...
	        if ($window.width() < breakpoint) {
				...
				if ( slideStateSmall ){
					...
					//jQuery("#recent-story").hide(); // now that we have the content, let's hide the old container (if it's the homepage)
        	...
        	var slideStateBig= /* these will not use the slider, but are used to hide it on window resize */
        		...
        		(jQuery("body#items").hasClass('browse items stories big')) ||
	        		...
	        		(jQuery("body#tours").hasClass('browse tour big'));	
